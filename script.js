...
for (let i = 0; i < number.length; i++){
    number[i].addEventListener("click", function(e) {
        ...
        // if result is currently displayed and user pressed and operator
            // we need to keep on adding to the string for nesxt operation
...
result.addEventListener("click", function() {
    ...
    // now we are looping trough the array doing one operation at a time/
    //first divide, then multiply, then substraction and then addition
